...
class IphoneScraper(scrapy.Spider):
    name = 'cellphoneS-macbook1'
    start_urls = ['https://cellphones.com.vn/laptop/mac/macbook-air.html',
    ...
    def parse_mac(self, response): 
        ...
        yield {
            ...
            'ROM': response.xpath('//*[@id="tskt"]/tbody/tr[5]/th[2]/text()').get() ,
            'OS': response.xpath('//*[@id="tskt"]/tbody/tr[9]/th[2]/text()').get() ,
            'CPU': response.xpath('//*[@id="tskt"]/tbody/tr[1]/th[2]/text()').get() ,
            'GPU': response.xpath('//*[@id="tskt"]/tbody/tr[2]/th[2]/text()').get(),
            'Screen size': response.xpath('//*[@id="tskt"]/tbody/tr[6]/th[2]/text()').get() ,
            'Type of Screen': response.xpath('//*[@id="tskt"]/tbody/tr[12]/th[2]/text()').get() ,
            'Color':  str(color),
            'Price_color': str(price_color),
            'Screen resolution': response.xpath('//*[@id="tskt"]/tbody/tr[7]/th[2]/text()').get() ,
            'Screen size': response.xpath('//*[@id="tskt"]/tbody/tr[1]/th[2]/text()').get() ,
            'RAM': response.xpath('//*[@id="tskt"]/tbody/tr[3]/th[2]/text()').get() ,
            'Weight': response.xpath('//*[@id="tskt"]/tbody/tr[11]/th[2]/text()').get() ,
            'Battery': response.xpath('//*[@id="tskt"]/tbody/tr[10]/th[2]/text()').get() ,
            'Bluetooth': response.xpath('//*[@id="tskt"]/tbody/tr[13]/th[2]/text()').get() ,
            'Wifi': response.xpath('//*[@id="technicalInfoModal"]/div/div/div[2]/div/div[5]/div[2]/table/tbody/tr[3]/th[2]/text()').get(),
            'Material': response.xpath('//*[@id="technicalInfoModal"]/div/div/div[2]/div/div[7]/div[2]/table/tbody/tr/th[2]/text()').get(),
